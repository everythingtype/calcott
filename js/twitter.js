...
var configProfile = {
  "profile": {"screenName": 'NicholasCalcott'},
  "domId": 'thetweet',
  "maxTweets": 1,
  "enableLinks": true, 
  "showUser": false,
...
//     var x = tweets.length;
//     var n = 0;
//     var element = document.getElementById('thetweet');
//     var html = '';
//     while(n < x) {
//       html += tweets[n];
//       n++;
...
// 
// 	var timeElements = document.getElementsByClassName('timePosted');
// 	i = timeElements.length;
// 	while(i--) {
// 		theTime = timeElements[i].innerHTML;
// 	}
// 
// 	document.getElementById('thetweetdate').innerHTML = theTime;
// 
// }